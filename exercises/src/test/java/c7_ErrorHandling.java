...
public class c7_ErrorHandling extends ErrorHandlingBase {
    ...
    public void have_a_backup() {
        ...
        Flux<String> messages = messageNode().onErrorResume(ex -> backupMessageNode());
    ...
    public void error_reporter() {
        //todo: feel free to change code as you need
        Flux<String> messages = messageNode().onErrorResume(e -> errorReportService(e)
                .then(Mono.error(e)));
    ...
    public void billion_dollar_mistake() {
        Flux<String> content = getFilesContent()
                ...
                .onErrorContinue((a, b) -> System.out.println("a:" + a + " b:" + b));
        //todo: change this line only
        ;
    ...
    public void resilience() {
        ...
        Flux<String> content = getFilesContent()
                .flatMap(f -> f.onErrorResume(e -> Mono.empty()));
    ...
    public void back_off() {
        Mono<String> connection_result = establishConnection().retryWhen(Retry.fixedDelay(2, Duration.ofSeconds(3)))
                //todo: change this line only
                ;
