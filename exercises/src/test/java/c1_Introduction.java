...
public class c1_Introduction extends IntroductionBase {
    ...
    public void hello_world() {
        ...
        String result = Mono.just("Hello World!").block(); //todo: change this line only
    ...
    public void unresponsive_service() {
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            ...
            serviceResult.timeout(Duration.ofSeconds(1),
                            Mono.error(new IllegalStateException("Timeout on blocking read for 1")))
